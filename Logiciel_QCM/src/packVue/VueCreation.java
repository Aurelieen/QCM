...
public class VueCreation extends JPanel {
                    ...
                    if (dateCorrecte(textFieldDateDebut.getText()) && dateCorrecte(textFieldDateFin.getText())) {
                        try {
                            ...
                            if (dateFin.after(dateDebut)) {
                                ...
                                jop1.showMessageDialog(null, "Les dates sont mal formatées, vérifiez qu'elles ne sont pas inversées ou identiques.", "Informations incorrectes", JOptionPane.ERROR_MESSAGE);
                            }

                        } catch (ParseException ex) {
                            JOptionPane jop1;
                            jop1 = new JOptionPane();
                            jop1.showMessageDialog(null, "Les dates ne sont pas correctement renseignées.", "Informations incorrectes", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {

                        JOptionPane jop1;
                        jop1 = new JOptionPane();
                        jop1.showMessageDialog(null, "Les dates sont mal formatées, vérifiez leurs dispositions.", "Informations incorrectes", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane jop1;
                    jop1 = new JOptionPane();
                    jop1.showMessageDialog(null, "Les champs fixes ne sont pas remplis.", "Informations incorrectes", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    private void analyserQuestionnaire() {
        ...
        if (nombreQuestionsValables > 0 && questionnaireValable) {
            ...
            JOptionPane jop1;
            jop1 = new JOptionPane();
            jop1.showMessageDialog(null, "Veuillez vérifier le contenu du QCM (champs vides, réponses bien cochées)", "Informations incorrectes", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        textFieldNom.setText("Veuillez saisir le nom du QCM");
        textFieldConsigne.setText("Indiquez des consignes si nécessaire");
        textFieldDateDebut.setText("19/01/2016 18:00:00");
        textFieldDateFin.setText("25/01/2016 18:00:00");
